...
const columns = [
  ...
  },
  {
    ...
    render: text => (
      <div>
        <div><span style={{ fontWeight: '800' }}>机构:&nbsp;&nbsp;</span>{text.institutions}</div>
        <div><span style={{ fontWeight: '800' }}>类型:&nbsp;&nbsp;</span>{text.style1}</div>
        <div><span style={{ fontWeight: '800' }}>userid:&nbsp;&nbsp;</span>{text.userid}</div>
      </div>
    ),
  },
  {
    ...
    render: text => (
      <div>
        <div><span style={{ fontWeight: '800' }}>账号:&nbsp;&nbsp;</span>{text.accountNumber}</div>
        <div><span style={{ fontWeight: '800' }}>昵称:&nbsp;&nbsp;</span>{text.nikeName}</div>
        <div><span style={{ fontWeight: '800' }}>手机:&nbsp;&nbsp;</span>{text.phone}</div>
      </div>
    ),
  },
  {
    ...
    render: text => (
      <div>
        <div><span style={{ fontWeight: '800' }}>标题:&nbsp;&nbsp;</span>{text.tit}</div>
        <div><span style={{ fontWeight: '800' }}>内容:&nbsp;&nbsp;</span>{text.cont}</div>
        <div><span style={{ fontWeight: '800' }}>时间:&nbsp;&nbsp;</span>{text.time}</div>
      </div>
    ),
  },
