...
const columns = [
  ...
  },
  {
    ...
    // console.log(record)
    <div>
      <div><span style={{fontWeight:'bold'}}>编号:</span>&nbsp;&nbsp;{text.numbering}</div>
      <div><span style={{fontWeight:'bold'}}>机构:</span>&nbsp;&nbsp;{text.institutions}</div>
      <div><span style={{fontWeight:'bold'}}>货商:</span>&nbsp;&nbsp;{text.merchants}</div>
      <div><span style={{fontWeight:'bold'}}>品牌:</span>&nbsp;&nbsp;{text.style}</div>
      <div><span style={{fontWeight:'bold'}}>状态:</span>&nbsp;&nbsp;{text.state}</div>
    </div>
  },
  {
    title: '更多明细',
    ...
    render:text =>
      // console.log(record)
      <div>
        <div><span style={{fontWeight:'bold'}}>品名：</span>&nbsp;{text.productName}</div>
        <div><span style={{fontWeight:'bold'}}>管理：</span>&nbsp;{text.management}</div>
        <div><span style={{fontWeight:'bold'}}>价格：</span>&nbsp;¥{text.price}</div>
        <div><span style={{fontWeight:'bold'}}>库存：</span>&nbsp;{text.inventory}</div>
        <div><span style={{fontWeight:'bold'}}>更新：</span>&nbsp;{text.update}</div>
      </div>
  },
  {
    title: '扫码浏览',
    ...
    return (
      <div className={style.bodys}>
          ...
          <div className={style.operation}>
              <div className={style.addContent}><Button type="primary">添加内容</Button></div>
              <div className={style.approved}><Button type="primary">审核通过</Button></div>
              <div className={style.search}><Button type="primary" onClick={()=>{this.onClick()}}>搜索</Button></div>
          </div>
